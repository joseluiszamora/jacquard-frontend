              ...
              <b-col md="12">
                <b-row>
                  <b-col md="3" class="p-0 d-none d-lg-block">
                    <EcommerceFilter class="mt-0" :responsive="false" />
                  </b-col>
                  <b-col md="12" lg="9" class="p-0">
                    <b-card-body class="pt-0 bg-transparent">
                      <b-row>
                        <b-col md="12">
                          <iq-card>
                            <div class="d-flex align-items-center justify-content-between p-2">
                              <div class="d-flex iq-algolia-search">
                                <b-button variant=" iq-bg-primary" class="d-lg-none mr-2 font-weight-bold" v-b-modal.modal-1>
                                  <i class="ri-menu-line mr-0 p-0"></i>
                                </b-button>
                               ...
                               <div class="d-flex justify-content-between">
                                 <div id="sort-by" class="iq-algolia-sort">
                                  ...
                                  <div class="d-flex">
                                    <b-button :variant="`${listType === 'grid' ? 'primary' : ' iq-bg-primary'}`" class="mr-2" @click="listType = 'grid'"><i class="ri-grid-fill mr-0 p-0" /></b-button>
                                    <b-button :variant="`${listType === 'list' ? 'primary' : ' iq-bg-primary'}`" class="" @click="listType = 'list'"><i class="ri-list-unordered mr-0 p-0" /></b-button>
                                  </div>
                                </div>
                               </div>
                          </iq-card>
